...
print("Currency: {0:s} \nExchange rate: {1:.4f}".format(rateDict[countryName]["currency"],eval(rateDict[countryName]["rate"])))
...
firstCountryName = input("(c) Enter name of first country: ")
secondCountryName = input("Enter name of second country: ")
amtOfMoney = float(input("Amount of money to convert: "))
resMoney = (1/eval(rateDict[firstCountryName]["rate"]))*eval(rateDict[secondCountryName]["rate"])*amtOfMoney
